...
if(biicore.isPremium) {
	...
	.bii-logo{position: fixed;bottom: 70px;right: 50px;width: 50px;height: 50px;z-index:99998;}
	...
	.bii-logo-secondary{position: absolute;width: 350px;right: 25px;height: 50px;overflow: hidden;visibility: hidden;}
	.bii-logo-secondary-content{position: absolute;width: 350px;right: -25px;background: #fff;height: 50px;padding: 13px 53px 13px 11px;border: 1px solid #df4759;border-radius: 30px;z-index: 9999;font-size:15px;transform: translate3d(100%, 0, 0);transition: transform 175ms ease;font-family: arial;font-weight: 200;color: #000;}
	@media (max-width: 799px) {
	  .bii-logo{bottom: 20px;right: 20px;}
	}
	</style>
	...
	<div class="bii-footer" style="background-color: #000;border-top:2px solid #df4759;padding: 15px 0;color:#fff;text-align:center;letter-spacing: 1px;"><div class="container">☆( © ${currentYear} <a style="color:#fff;" href="https://biihappy.com/wedding" target="_blank">Biihappy.com</a> | <a style="color:#fff;" href="https://biihappy.com/wedding" target="_blank">Nền tảng tạo website đám cưới miễn phí từ Biihappy</a> )☆</div></div>
	`);
}